function [D, H,obj, gradient]=wasserstein_NMF_dictionary_step(X,K,lambda,gamma,rho,H,options,isHist)
%% Dictionary step of Wasserstein NMF
% This function solves 
%
%               min_{lambda} W_gamma(X,D*lambda) + rho*E(D)
%
% Inputs:
